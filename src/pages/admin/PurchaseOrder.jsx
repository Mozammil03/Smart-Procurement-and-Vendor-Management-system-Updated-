  ...
  return (
    <Box sx={{ bgcolor: "#f4f7f6", minHeight: "100vh", py: 4 }}>
        ...
        >
          <Stack direction="row" spacing={2} alignItems="center">
            ...
            <Button
              variant="contained"
              onClick={searchPO}
              sx={{ bgcolor: "#1a237e", px: 4, fontWeight: "bold" }}
            >
              SEARCH
            </Button>
            <IconButton
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12}>
                    <Button
                      ...
                      type="submit"
                      size="large"
                      sx={{ bgcolor: "#1a237e", fontWeight: "bold", mt: 1 }}
                    >
          ...
          {viewPO && (
            <Stack spacing={1.5}>
              <Box>
                ...
                <Typography fontWeight="bold">{viewPO.poNumber}</Typography>
              </Box>
              <Box>
                <Typography variant="caption" color="text.secondary">
                  Vendor
              ...
              <Box>
                ...
                <Typography>{viewPO.orderDate || "—"}</Typography>
              </Box>
              <Box>
                <Typography variant="caption" color="text.secondary">
                  Total Amount
                ...
                <Typography fontWeight="bold" color="#1a237e">
                  {viewPO.totalAmount != null
                    ? `₹ ${parseFloat(viewPO.totalAmount).toLocaleString()}`
                    : "—"}
                </Typography>
              </Box>
              <Box>
              ...
              <Box>
                ...
                <Typography>#{viewPO.requisition?.id || "—"}</Typography>
              </Box>
            </Stack>
          )}
        </DialogContent>
      ...
      <Dialog open={openDelete} onClose={() => setOpenDelete(false)}>
        ...
        <DialogContent>
          <DialogContentText>
            Are you sure you want to delete PO #{selectedId}?
          </DialogContentText>
        </DialogContent>
        <DialogActions sx={{ p: 2 }}>
